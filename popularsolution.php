...
<body>
	<div class="breadcrumb"> >> Knowledge Based >> Popular Solution</div>
	<hr/>
	<h1>Popular Solution By Product Category</h1>
	<p>Voice : <strong><?php echo $tickets_count; ?></strong> tickets </p>
	<p>Data : <strong><?php echo $tickets_count; ?></strong> tickets </p>
	<p>Voice and Data : <strong><?php echo $tickets_count; ?></strong> tickets </p>
