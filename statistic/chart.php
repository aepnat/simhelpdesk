...
<table width="100%">
<tr><td width="50%">
	<div style="background-color:#bb2a26;" class="border-radius" id="Chart1">Loading FusionCharts!</div>
	</td>
	<td width="50%">
	<div style="background-color:#bb2a26;" class="border-radius" id="Chart2">Loading FusionCharts!</div>
	</td>
</tr>
<tr><td colspan="2">
	<div style="background-color:#bb2a26;" class="border-radius" id="Chart3">Loading FusionCharts!</div>
	</td>
</tr>
</table>
