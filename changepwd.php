...
<head>
	...
	<style type="text/css">
		...
		.form fieldset{border: #cce0b8 solid 1px;width:400px;margin-bottom:20px;background-color: #265180;color: #ffffff;}
		.form legend{text-transform:uppercase;font-size:14px;padding:4px;background-color: #3e698c;}
